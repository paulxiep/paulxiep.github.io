...
export const projectRepos: ProjectConfig[] = [
	...
	{ repo: 'caravan', sortOrder: 4, featured: false, canonical: 'https://paulxlab.com/caravan' },
	{ repo: 'daccord', sortOrder: 5, featured: false, title: "D'accord" },
	{ repo: 'concurrens', sortOrder: 6, featured: false, private: true },
	{ repo: 'cartodex', sortOrder: 7, featured: true, demoUrl: 'https://cartodex.app', externalDemo: true },
